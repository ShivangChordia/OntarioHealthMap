/*
* File: DiseaseAnalysis.jsx
* Project: OntarioHealthMap
* Programmers: Shivang Chordia, Urvish Motivaras, Keval Patel, Jaygiri Goswami
* Date: 13-04-2025
* Description: Displays interactive disease analysis for various types of diseases, includes
*              data visualizations such as charts, maps, and comparison analysis.
*/
